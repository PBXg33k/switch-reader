...
void Domain::prefill_gallery(Entry* e, std::vector<Resource*>* img_buffer, Gallery* gallery){}
void Domain::load_gallery_urls(size_t page, int* block_size, Gallery* gallery){}

int Domain::download_gallery(std::vector<Resource*> pages, Gallery* gallery, std::string directory){ return 1; }
